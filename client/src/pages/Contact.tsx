          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://twitter.com" className="text-slate-400 hover:text-white transition-colors">
            ...
            <Card className="mt-8 p-6 bg-blue-50">
              ...
              <Button variant="ghost" className="text-blue-600 hover:text-blue-800 text-sm font-medium p-0">
                <a target="_blank" rel="noopener noreferrer" href="/faq" className="inline-flex items-center">
