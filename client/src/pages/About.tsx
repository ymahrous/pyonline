    ...
    <div className="py-12 bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-slate-800 mb-4">About PyOnline</h1>
        ...
        <div className="prose prose-lg max-w-none">
          <Card className="bg-blue-50 p-8 mb-8">
            ...
            <p className="text-slate-700">
              At PyOnline, we believe that learning to code should be fun, interactive, and accessible to everyone. 
